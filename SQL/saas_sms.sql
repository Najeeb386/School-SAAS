...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 26, 2026 at 10:21 AM
...
(1, 3, 'Student', 180.00, 800, 'yearly', '2026-01-24', '2027-01-24', 'active', '2026-01-24 10:26:09'),
...
INSERT INTO `schools` (`id`, `name`, `subdomain`, `email`, `password`, `contact_no`, `estimated_students`, `total_student`, `plan`, `status`, `storage_used`, `db_size`, `start_date`, `expires_at`, `created_at`, `updated_at`) VALUES
(1, 'Test School', 'testschool', 'test@gmail.com', '$2y$10$lgqaKyAf5uJ652fVslomfe6QuJkbJpao0M87Jiap/WDxPmZl0zKWq', '03272352752', 1000, NULL, 'Student', 'active', 0, 0, '2026-01-23 00:00:00', '2027-02-22 00:00:00', '2026-01-22 17:30:18', '2026-01-26 10:12:12'),
(2, 'Iqra School', 'iqra-school', 'iqra@gmail.com', '$2y$10$VhQezHPbvVIrzNHlS.IZKOdnNhRkMIf1bOdK.Zxnqz9vahfItGFlC', '23131241', 500, NULL, 'hosted', 'active', 0, 0, '2026-01-24 00:00:00', '2028-02-23 00:00:00', '2026-01-24 07:55:46', '2026-01-24 08:45:05'),
(3, 'check', 'check.com', 'khan@gmail.com', '$2y$10$ePSILathFE1hl8cMWv1/k.fTgb/LIQhF.SqxtL.T0jrs2NAEl7re6', '121212', 800, NULL, 'Student', 'active', 0, 0, '2026-01-24 00:00:00', '2027-01-24 00:00:00', '2026-01-24 15:26:09', '2026-01-24 15:26:09'),
(4, 'Ali Raza', 'Inventoryhub', 'ali@gmail.com', '$2y$10$aYyuD3tCsjLktQGgPczqtehtVV.OWfOUL/F4DyH/iZUQ.niyItikq', '12123', 300, NULL, 'hh', 'active', 0, 0, '2026-01-24 00:00:00', '2027-01-24 00:00:00', '2026-01-24 15:33:04', '2026-01-24 15:37:21'),
(5, 'najeeb hassan', 'nn', 'Najeeb@gmail.com', '$2y$10$vm5SqIdpM0QGRVqeHlTtPeIskaGk4WC5rKUifFNHsNtAgBrWDac8u', '11', 300, NULL, 'hh', 'active', 0, 0, '2026-01-25 00:00:00', '2027-01-25 00:00:00', '2026-01-25 07:52:37', '2026-01-25 07:52:37'),
(6, 'ik jahan', 'test', 'to@gmail.com', '$2y$10$VZalxUYfFxhERpKLQ5hDLeYh1dJ6EilNLOOGM4FjBDq2YBX2SF0Mi', '123', 300, NULL, 'hh', 'active', 0, 0, '2026-01-25 00:00:00', '2027-01-25 00:00:00', '2026-01-25 08:18:41', '2026-01-25 08:18:41'),
(7, 'pp', 'pp', 'pp@gmail.com', '$2y$10$o.UVdOcgwl8Cah/2nejqWeldeTpwt0BQHGXGLW1pRv3ue5z1am9Ka', '121', 400, NULL, 'hh', 'active', 0, 0, '2026-01-25 00:00:00', '2027-01-25 00:00:00', '2026-01-25 09:14:10', '2026-01-25 09:14:10'),
(8, 'discounted test', 'tt', 'ttt@gmail.com', '$2y$10$aY8bCUt1/SiAU4OxQ.9L.e6qS1xoHsbykWKjr0xychBiT8sg/z5oK', '121', 20, NULL, 'hh', 'active', 0, 0, '2026-01-25 00:00:00', '2027-01-26 00:00:00', '2026-01-25 10:38:18', '2026-01-26 09:55:19'),
(9, 'debug', 'debug', 'lol@mail.com', '$2y$10$J7/a137jEPWJXybJJThHJuXmFMQKGif5zcHkkZbdk/9sKlfs5ibP.', '12', 10, NULL, 'hh', 'blocked', 0, 0, '2026-01-26 00:00:00', '2027-01-26 00:00:00', '2026-01-26 06:20:06', '2026-01-26 13:30:17');
