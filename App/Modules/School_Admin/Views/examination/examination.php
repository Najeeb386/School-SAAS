                ...
                <div class="app-main" id="main">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                                    ...
                                    <div class="card shadow-sm h-100">
                                        <div class="card-body d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted">Manage grading standards</small>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="col-md-3 mb-4">
                                <a href="generate_exam/generate_exam.php" class="text-dark text-decoration-none">
                                    <div class="card shadow-sm h-100">
                                        <div class="card-body d-flex align-items-center">
                                            <div class="mr-3">
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted">Manage exam schedules and details</small>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="col-md-3 mb-4">
                                <a href="results/upload_marks.php" class="text-dark text-decoration-none">
                                    <div class="card shadow-sm h-100">
                                        <div class="card-body d-flex align-items-center">
                                            <div class="mr-3">
                                    ...
                                    <div class="card shadow-sm h-100">
                                        <div class="card-body d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted">summaries & exports</small>
                                            </div>
                                        </div>
                                    </div>
                                </a>
