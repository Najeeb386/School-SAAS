<aside class="app-navbar">
                    ...
                    <div class="sidebar-nav scrollbar scroll_light">
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li><a href="../../views/students/students.php" aria-expanded="false"><i class="nav-icon ti ti-comment"></i><span class="nav-title">Student</span></a> </li>
                            ...
                            <li><a href="../../views/attendence/attendence.php" aria-expanded="false"><i class="nav-icon ti ti-comment"></i><span class="nav-title">Attendence</span></a> </li>
