                            ...
                            <div class="col-sm-6 col-lg-5 col-xl-3  align-self-center order-2 order-sm-1">
                                <div class="d-flex align-items-center h-100-vh">
                                    <div class="login p-50 w-100">
                                        ...
                                        <h4 class="mt-4">Forget Password !</h4>
                                        <span class="mt-1"><i class="fa fa-envelope"></i> Enter your email to reset password</span>
                                        <p class="mt-4 mb-0">You must enter your email to reset password</p>
                                        <div class="input-group my-3">
                                            <input type="email" required class="form-control" placeholder="Enter Email" aria-label="" aria-describedby="basic-addon2">
                                        ...
                                        <p class="mt-4 mb-0">Or sign in as a <a class="text-primary" href="login.php">Sign in</a></p>
                                    </div>
                                </div>
                            </div>
